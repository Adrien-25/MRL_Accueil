...
if((isset($_POST['title'])) && (isset($_POST['link'])) && (isset($_FILES['image']['name']))){
    ...
    <span>X</span>
    <p><b>titre du slider : </b>'.$_POST['title'].'</p>
    <p><b>lien du slider : </b>'.$_POST['link'].'</p>
    <p><img style="width: 300px" src="'.$slide_image_url.'">
    </p>
    </div>';
}
...
foreach ( $results as $row ) 
{
    ...
    echo '<img style="width: 300px" src="'.$row->slide_image.'"><br>';
